/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pela validação, tratamento e manipulação de dados para o CRUD do enquadramento.
 * Data: 12/06/2026
...
const enquadramentoDAO = require("../../model/DAO/enquadramento/enquadramento.js")
const { json } = require("body-parser")

/* FUNÇÕES PARA O CRUD DO ENQUADRAMENTO */

//função para retornar todos os enquadramentos cadastrados
const listarEnquadramento = async function(){
    ...
    try {
        ...
        let result = await enquadramentoDAO.selectAllEnquadramento()
        ...
        if(result){
            ...
            if(result.length > 0){
                ...
                message.DEFAULT_MESSAGE.response.enquadramento = result
...
//função para buscar um enquadramento pelo id
const buscarEnquadramentoId = async function(id){
    ...
    try {
        ...
        //se o id estiver no formato correto ele ennvia pro DAO
            ...
            let result = await enquadramentoDAO.selectByIdEnquadramento(id) //enviando o id pro DAO concluir o script
