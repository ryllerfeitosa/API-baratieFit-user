/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pela validação, tratamento e manipulação de dados para o CRUD do nivel de acesso.
 * Data: 15/06/2026
...
/* FUNÇÕES PARA O CRUD DO NIVEL DE ACESSO */

//função para retornar todos os niveis de acesso cadastrados no banco de dados
    ...
    try {
        ...
        if(result){
            ...
            if(result.length > 0){
                ...
                message.DEFAULT_MESSAGE.response.nivelAcesso = result
...
const buscarNivelAcesso = async function(id){
    ...
    try {
        ...
        //se o id estiver no formato correto ele ennvia pro DAO
            ...
            let result = await nivelAcessoDAO.selectByIdNivelAcesso(id) //enviando o id pro DAO concluir o script
