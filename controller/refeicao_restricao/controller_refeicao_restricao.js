/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pela validação, tratamento e manipulação de dados para o CRUD da tabela intermediária de refeição e restricao.
 * Data: 17/06/2026
...
/* FUNÇÕES PARA O CRUD DA TABELA INTERMEDIÁRIA DE REFEIÇÃO E RESTRICAO */
    ...
    try {
        ...
        if(result){
            ...
            if(result.length > 0){
                ...
                message.DEFAULT_MESSAGE.response.refeicaoRestricao = result
...
const buscarRefeicaoRestricao = async function(id){
    ...
    try {
        ...
        //se o id estiver no formato correto ele ennvia pro DAO
            ...
            let result = await refeicaoRestricaoDAO.selectByIdRefeicaoRestricao(id) //enviando o id pro DAO concluir o script
