/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pela validação, tratamento e manipulação de dados para o CRUD da tabela intermediária de refeição e alimento.
 * Data: 17/06/2026
...
const refeicaoAlimentoDAO = require("../../model/DAO/refeicao_alimento/refeicao_alimento.js")
const { json } = require("body-parser")

/* FUNÇÕES PARA O CRUD DA TABELA INTERMEDIÁRIA DE REFEIÇÃO E ALIMENTO*/

//função para retornar todas os dados da tabela
const listarRefeicaoAlimento = async function(){
    ...
    try {
        ...
        let result = await refeicaoAlimentoDAO.selectAllRefeicaoAlimento()
        ...
        if(result){
            ...
            if(result.length > 0){
                ...
                message.DEFAULT_MESSAGE.response.refeicaoAlimento = result
...
const buscarRefeicaoAlimento = async function(id){
    ...
    try {
        ...
        //se o id estiver no formato correto ele ennvia pro DAO
            ...
            let result = await refeicaoAlimentoDAO.selectByIdRefeicaoAlimento(id) //enviando o id pro DAO concluir o script
...
/* EXPORTANDO FUNÇÕES */
module.exports = {
    listarRefeicaoAlimento,
    buscarRefeicaoAlimento
}