/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pela validação, tratamento e manipulação de dados para o CRUD de adm.
 * Data: 17/06/2026
...
/* FUNÇÕES PARA O CRUD DE ADM */

//função para retornar todas os dados da tabela de adm
    ...
    try {
        ...
        if(result){
            ...
            if(result.length > 0){
                ...
                message.DEFAULT_MESSAGE.response.adm = result
...
const buscarAdm = async function(id){
    ...
    try {
        ...
        //se o id estiver no formato correto ele ennvia pro DAO
            ...
            let result = await admDAO.selectByIdAdm(id) //enviando o id pro DAO concluir o script
