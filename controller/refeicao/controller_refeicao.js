/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pela validação, tratamento e manipulação de dados para o CRUD das refeições.
 * Data: 17/06/2026
...
const refeicaoDAO = require("../../model/DAO/refeicao/refeicao.js")
const { json } = require("body-parser")

/* FUNÇÕES PARA O CRUD DAS REFEIÇÕES */

//função para retornar todas as refeições
const listarRefeicao = async function(){
...
//função para buscar uma refeicao pelo id
const buscarRefeicao = async function(id){
    ...
    try {
        ...
        //se o id estiver no formato correto ele ennvia pro DAO
            ...
            let result = await refeicaoDAO.selectByIdRefeicao(id) //enviando o id pro DAO concluir o script
