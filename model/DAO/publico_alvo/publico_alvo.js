/********************************************************************************************************************************************************************************************
 * Objetivo: Arquivo responsável pelo CRUD no Banco de dados MySQL na tabela de publico alvo.
 * Data: 12/06/2026
...
/* INICIANDO CRUD DA TABELA TIPO REFEICAO */

//retornar todos os publicos alvos cadastrados no banco de dados
const selectAllPublicoAlvo = async function(){

    try {
        
        //criando variável sql
        let sql = `select * from tbl_publico_alvo order by id desc;`
...
//retorna os publicos alvos com base no id
const selectByIdPublicoAlvo = async function(id){

    try {
        
        let sql = `select * from tbl_publico_alvo where id = ${id}`
...
module.exports = {
    selectAllPublicoAlvo,
    selectByIdPublicoAlvo
}